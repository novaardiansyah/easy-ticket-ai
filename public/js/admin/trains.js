  ...
  $table.DataTable({
    ...
    columns: [
      ...
      { data: 'name' },
      {
        data: 'status',
        render: function(data) {
          const cls = data === 'active' ? 'success' : 'danger';
          return `<span class="badge bg-${cls}">${data}</span>`;
        }
      },
      { data: 'carriages_count' },
      {
        data: 'id',
        searchable: false,
          ...
          return `
            <div class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li>
                  <form action="${deleteUrl}" method="POST" class="d-inline" onsubmit="return confirm('Delete this train?')">
