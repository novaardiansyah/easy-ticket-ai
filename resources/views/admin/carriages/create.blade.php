...
<div class="app-content-header">
  <div class="container-fluid">
    <div class="row">
      <div class="col-sm-6"><h3 class="mb-0">Create Carriage</h3></div>
      <div class="col-sm-6">
...
<div class="card">
  ...
  <div class="card-body">
    <form action="{{ route('admin.carriages.store') }}" method="POST">
      @csrf
      <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <select name="class" class="form-select @error('class') is-invalid @enderror" required>
          ...
          <option value="{{ $cls }}" {{ old('class') === $cls ? 'selected' : '' }}>{{ ucfirst($cls) }}</option>
          @endforeach
        </select>
      ...
      <div class="mb-3">
        ...
        <input type="number" name="capacity" class="form-control @error('capacity') is-invalid @enderror" value="{{ old('capacity') }}" min="1" max="100" required>
